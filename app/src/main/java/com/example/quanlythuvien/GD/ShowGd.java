...
public class ShowGd extends Activity {
    GridView grvsach;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final AdapterSach quyensachadapter=new AdapterSach(ShowGd.this,R.layout.activity_sach,sachArrayList);
    ...
    private void addevent() {
        btnthoatkhkt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ShowGd.this.onBackPressed();
            }
        });
        btnthem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ShowGd.this, AddGd.class);
        ...
        grvsach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(ShowGd.this, ThongtinGd.class);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if(snapshot.exists()){
                            ...
                            Toast.makeText(ShowGd.this, "Xóa thành công !", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(ShowGd.this, "Lỗi không thể xóa!", Toast.LENGTH_SHORT).show();
                    }
                });
                return false;
            }
